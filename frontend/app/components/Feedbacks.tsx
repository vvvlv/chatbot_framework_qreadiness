...
export function Feedbacks({ onSend, close, user_id }: FeedbackProps) {
    ...
    return (
        <div className="flex flex-col absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:1/3 xs:w-2/5 xs:min-w-xs w-9/10 bg-beige rounded-2xl border px-4 py-4 md:px-6 md:py-6 items-center gap-4">
